    ...
    if [[ "$yn" =~ ^(n|N|no|No) ]]; then
        if [[ -n "$(ls ../../1-Raw_Measures/$1)" ]]; then
            ...
            for file in $(find ../../1-Raw_Measures/$1 -name *combined*txt); do
                ...
                python ~/Documents/Phonetics_Lab_Summer_2017/Phonetics-Lab/FULL_PROCEDURE/Section-1_making_COSPRO_Dataset/Phase-5_Align_Files/split_measures.py ../../1-Raw_Measures/$1$file ../../2-Formatted_Measures/$1
            done
...
if [[ "$yn" =~ ^(y|Y|yes|Yes) ]]; then
    ...
    bash ~/Documents/Phonetics_Lab_Summer_2017/Phonetics-Lab/FULL_PROCEDURE/Section-1_making_COSPRO_Dataset/Phase-6_Create_Combined_Dataset/apply_task2_formatting.sh $1
...
corpus=${1%/}
python ~/Documents/Phonetics_Lab_Summer_2017/Phonetics-Lab/FULL_PROCEDURE/Section-1_making_COSPRO_Dataset/Phase-6_Create_Combined_Dataset/combine_tables.py parts/ $corpus_combined.txt
