	...
	case $TYPE in
		...
		[Ww][Oo][Rr][Dd] | [Ww])
			...
			if [[ "$number" =~ ^[0-9]+$ ]]; then
				...
				if ! [ $COS ]; then
					echo "Can't find local COSPRO_01 directory."
					COS='~/Desktop/COSPRO_DATA_BIN/Active/COSPRO_01'
				fi
				...
				if [ $ALLSP -eq 1 ]; then
					...
					/Applications/Praat.app/Contents/MacOS/Praat --open $W1 $T1 
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat '$W2' '$T2' 
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat '$W3' '$T3' 
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat '$W4' '$T4' 
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat '$W5' '$T5' 
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat '$W6' '$T6';
				# otherwise open the specified file
					...
					echo $TG
					/Applications/Praat.app/Contents/MacOS/Praat --run open_file_or_files.praat $WAV $TG
				fi
