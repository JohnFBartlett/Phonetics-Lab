This repo contains scripts I wrote for use in the Penn Phonetics Laboratory. The scripts are written in bash, Python, matlab and Praat and range in length from 2 to 800 lines.
